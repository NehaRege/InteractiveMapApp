...
public class SuActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        textViewName.setText("Student Union");
        textViewAdd.setText("Student Union Building, San Jose, CA 95112");
        image.setImageResource(R.drawable.su);


        buttonStreetView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(SuActivity.this,StreetViewPanoramaActivity.class);
                intent1.putExtra("key_su","su");
    ...
    public void loadDistTimeEngg(String currLocation) {
        ...
        Call<TimeDistanceModel> call = request.getTimeDistSu(currLocation);
